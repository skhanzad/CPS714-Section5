...
export const createItem = async (req, res) => {
  try {
    if (req.body.mediaFormat) {
      req.body.mediaFormat = req.body.mediaFormat.toUpperCase();
    }
    if (req.body.status) {
...
export const updateItem = async (req, res) => {
    ...
    if (req.body.mediaFormat) req.body.mediaFormat = req.body.mediaFormat.toUpperCase();
